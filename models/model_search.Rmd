...
Log model
```{r}
model_args <- list(model='search', model_file = 'toplevel.json', add_cols=c('Week_num'), log=FALSE, scale=1)
...
```{r}
params_search(c('OnlineVideo_YouTube_ProspectiveQLE_GM_Prospecting_Weber_Clicks'), model1)
